...
import dedrarion.common.registry.ModBlocks;
import dedrarion.common.registry.ModItems;
        ...
        public void generate(HolderLookup.@NotNull Provider provider,
            ...
            Advancement DEDRARION_UNDERGROUND_MAIN = Advancement.Builder.advancement()
                    .display(
                            ...
                            ResourceLocation.fromNamespaceAndPath(Dedrarion.MOD_ID, "textures/block/ethereum_block.png"),
                            FrameType.TASK,
                    ...
                    .save(consumer, String.valueOf(ResourceLocation.fromNamespaceAndPath(Dedrarion.MOD_ID, "dedrarion_underground_main")));
            ...
            Advancement SEEKER_OF_MAGIC = Advancement.Builder.advancement()
                    ...
                    .save(consumer, String.valueOf(ResourceLocation.fromNamespaceAndPath(Dedrarion.MOD_ID, "seeker_of_magic")));
            ...
            Advancement WHITE_PRINCE = Advancement.Builder.advancement()
                    ...
                    .save(consumer, String.valueOf(ResourceLocation.fromNamespaceAndPath(Dedrarion.MOD_ID, "white_prince")));
            ...
            Advancement COLLECTOR_OF_JEWELRY = Advancement.Builder.advancement()
                    ...
                    .save(consumer, String.valueOf(ResourceLocation.fromNamespaceAndPath(Dedrarion.MOD_ID, "collector_of_jewelry")));
        }
    }
}
