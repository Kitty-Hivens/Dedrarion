...
import dedrarion.common.datagen.builder.EftoritForgeRecipeBuilder;
import dedrarion.common.recipe.EftoritIngredient;
...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected static void eftoritForgeRecipe(
        ...
        builder.save(consumer, ResourceLocation.fromNamespaceAndPath(Dedrarion.MOD_ID, recipeName));
    }
    ...
    protected static void autoGenerateForgeRepair(@NotNull Consumer<FinishedRecipe> consumer) {
        for (ItemLike repairItem : ModRecipeProvider.TOOLS_TO_REPAIR) {
            ...
            builder.save(consumer, ResourceLocation.fromNamespaceAndPath(Dedrarion.MOD_ID, "repair_" + itemName + "_with_eftorit"));
        }
    }
