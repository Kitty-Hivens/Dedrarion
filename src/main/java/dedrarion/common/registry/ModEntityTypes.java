...
import dedrarion.common.entity.DelayedExplosionEntity;
import dedrarion.common.entity.NullGuardianEntity;
import dedrarion.common.entity.PrimedJokerBomb;
...
public class ModEntityTypes {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, Dedrarion.MOD_ID);
