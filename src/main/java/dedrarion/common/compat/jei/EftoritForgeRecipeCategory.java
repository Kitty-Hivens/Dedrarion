package dedrarion.common.compat.jei;

import dedrarion.Dedrarion;
import dedrarion.common.recipe.EftoritForgeRecipe;
...
public class EftoritForgeRecipeCategory implements IRecipeCategory<EftoritForgeRecipe> {
    public static final RecipeType<EftoritForgeRecipe> TYPE =
            RecipeType.create(Dedrarion.MOD_ID, "eftorit_forging", EftoritForgeRecipe.class);

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Dedrarion.MOD_ID, "textures/gui/eftorit_forge_jei.png");
