...
public class BlockRegistry {
    ...
    public static final RegistryObject<StairBlock> HOPE_STONE_STAIRS = registerBlock("hope_stone_stairs",
            () -> new StairBlock(() -> BlockRegistry.HOPE_STONE.get().defaultBlockState(), BlockBehaviour.Properties
                    .copy(BlockRegistry.HOPE_STONE.get()))
    );
    ...
    public static final RegistryObject<StairBlock> HOPE_SHARD_STAIRS = registerBlock("hope_shard_stairs",
            () -> new StairBlock(() -> BlockRegistry.HOPE_SHARDS.get().defaultBlockState(), BlockBehaviour.Properties
                    .copy(BlockRegistry.HOPE_STONE.get()))
    );

    // Hope Bricks Stairs
    public static final RegistryObject<StairBlock> HOPE_BRICK_STAIRS = registerBlock("hope_brick_stairs",
            () -> new StairBlock(() -> BlockRegistry.HOPE_STONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties
                    .copy(BlockRegistry.HOPE_STONE.get()))
    );

    public static final RegistryObject<StairBlock> SMOOTH_HOPE_BRICK_STAIRS = registerBlock("smooth_hope_brick_stairs",
            () -> new StairBlock(() -> BlockRegistry.SMOOTH_HOPE_STONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties
                    .copy(BlockRegistry.HOPE_STONE.get()))
    );

    public static final RegistryObject<StairBlock> HOPE_SHARD_BRICK_STAIRS = registerBlock("hope_shard_brick_stairs",
            () -> new StairBlock(() -> BlockRegistry.HOPE_SHARD_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties
                    .copy(BlockRegistry.HOPE_STONE.get()))
    );
