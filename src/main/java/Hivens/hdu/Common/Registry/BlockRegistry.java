...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> ETHEREUM_ORE = registerBlock("ethereum_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.DIAMOND_ORE).sound(SoundType.NETHER_GOLD_ORE)
                    .strength(120f).requiresCorrectToolForDrops(), UniformInt.of(1, 1)));
    public static final RegistryObject<Block> ETHEREUM_BLOCK = registerBlock("ethereum_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.OBSIDIAN).sound(SoundType.NETHER_GOLD_ORE)
                    .strength(180f).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Block> RUBY_ORE = registerBlock("ruby_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.LAPIS_ORE).sound(SoundType.METAL)
                    .strength(15f).requiresCorrectToolForDrops(), UniformInt.of(1, 3)));
    ...
    public static final RegistryObject<Block> SMOOTH_HOPE_STONE = registerBlock("smooth_hope_stone",
            () -> new Block(BlockBehaviour.Properties.copy(BlockRegistry.HOPE_STONE.get())));
    ...
    public static final RegistryObject<StairBlock> HOPE_STONE_STAIRS = registerBlock("hope_stone_stairs",
            () -> new StairBlock(() -> BlockRegistry.HOPE_STONE.get().defaultBlockState(), BlockBehaviour.Properties.copy(BlockRegistry.HOPE_STONE.get())));

    public static final RegistryObject<StairBlock> SMOOTH_HOPE_STONE_STAIRS = registerBlock("smooth_hope_stone_stairs",
            () -> new StairBlock(() -> BlockRegistry.SMOOTH_HOPE_STONE.get().defaultBlockState(), BlockBehaviour.Properties.copy(BlockRegistry.HOPE_STONE.get())));

    public static final RegistryObject<StairBlock> HOPE_SHARD_STAIRS = registerBlock("hope_shard_stairs",
            () -> new StairBlock(() -> BlockRegistry.HOPE_SHARDS.get().defaultBlockState(), BlockBehaviour.Properties.copy(BlockRegistry.HOPE_STONE.get())));

    // Hope Bricks Stairs
    public static final RegistryObject<StairBlock> HOPE_BRICK_STAIRS = registerBlock("hope_brick_stairs",
            () -> new StairBlock(() -> BlockRegistry.HOPE_STONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(BlockRegistry.HOPE_STONE.get())));

    public static final RegistryObject<StairBlock> SMOOTH_HOPE_BRICK_STAIRS = registerBlock("smooth_hope_brick_stairs",
            () -> new StairBlock(() -> BlockRegistry.SMOOTH_HOPE_STONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(BlockRegistry.HOPE_STONE.get())));

    public static final RegistryObject<StairBlock> HOPE_SHARD_BRICK_STAIRS = registerBlock("hope_shard_brick_stairs",
            () -> new StairBlock(() -> BlockRegistry.HOPE_SHARD_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(BlockRegistry.HOPE_STONE.get())));
